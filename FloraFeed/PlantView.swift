...
struct PlantTableView: View {
    @State private var plants = [
        ...
        Plant(name: "Actually fake", photo: "IMG_5716", idealLighting: LIGHTING.SHADE, moisture: MOISTURE.BONE_DRY, humidity: HUMIDTY.NORMAL, temperature: TEMPERATURE.NORMAL),
        Plant(name: "On the edge", photo: "IMG_5721", idealLighting: LIGHTING.BRIGHT_LIGHT, moisture: MOISTURE.BONE_DRY, humidity: HUMIDTY.NORMAL, temperature: TEMPERATURE.NORMAL),
